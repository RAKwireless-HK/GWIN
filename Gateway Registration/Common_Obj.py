...
class EMSD_Project:
    def __init__(self, _emsd_project):
        ...
        self.project_code_SLP = _emsd_project['Project_Code_SLP']
        self.project_code_FSD = _emsd_project['Project_Code_FSD']
        self.project_code_DSD = _emsd_project['Project_Code_DSD']
